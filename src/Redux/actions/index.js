...
export const removeCategoryFromCart = (category) => ({
  type: 'REMOVE_CATEGORY_FROM_CART',
  payload: category,
});

export const removeSelectedItemsFromCart = (category, selectedIds) => ({
  type: 'REMOVE_SELECTED_ITEMS_FROM_CART',
  payload: { category, selectedIds },
});
